...
function btnDisabled(btn) {
    btn.style.color = "fff";
    btn.style.border = "2px solid rgb (204, 0, o)";
...
function stopGame() {
    hideGameMsg(); { // clear the text and hide message box
        ...
        for (var i=0; i<arrayX.length;i++) {
            arratX[i].style.transform = "translateY(100%)";
        }
...
function hideGameMsg () {
    ...
    document.getElementById('gameMsg').style.display = 'none'; // hide the div
}
...
function getAvatars() {
    var p1Avatar = document.getElementById("plDisplay").innerHTML;
...
function determineAvatar() {
    ...
    var active = document.getElementById('showPlayer').innerHTML; // get active players
...
function avatarPlaced() {
    ...
    activePlayer = showPlayer.innerHTML; //get the current player from element
...
function checkForWinCon() {
    ...
    // call this following array of cunctions to check for any of the possible win cons
...
function glowBoard(pos) {
    ...
    for (var i=0;i<squares.length;i++) {
        if (i == index0) {
            ...
            setTimeout(function() {bg1.style.backgroundColor = 'rgb(66, 244, 255)';}, 1000);
...
// call this functione to make entire background color
...
//------------------------------------------------------------------------------
//these function are the allgorithms to find all win conditions
//------------------------------------------------------------------------------
...
function checkWinCon1 (info,squareArray) {
    ...
    if (match0Avatar !=undefined && match1Avatar != undefined && match2Avatar != undefined) {
        if (match0Avatar == match1Avatar && match0Avatar == match2Avatar != undefined) {
...
function checkWinCon2 (info,squareArray) {
    ...
    if (match3Avatar !=undefined && match4Avatar != undefined && match5Avatar != undefined) {
        if (match3Avatar == match4Avatar && match3Avatar == match5Avatar != undefined) {
        winDetected = "win";
        }
    }
...
function square1Animate () {
    ...
    if (activePlayer != "Game Stopped") { // if game has not yet started prevent avatar placement
        ...
        if (verdict == undefined) { // if verdict is empty than the square is unoccupied.
            ...
            var paintAvatar = document.getElementsByClassName(paintAvatar) [0]; // paint avatar
            ...
            squareSound(); // play game sound when the avatar is placed
        }
    }
}
...
// this function will perform the animation for the ) avatar.
